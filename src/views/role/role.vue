<template>
  <div class="table">
    ...
    <el-dialog title="设置权限" :visible.sync="dialogPowerVisible">
      <el-tree ref="powerTree" :data="powerTree" :props="defaultProps" :default-checked-keys="powerTemp.permIds" node-key="id" check-strictly show-checkbox default-expand-all>
      </el-tree>
      <div slot="footer" class="dialog-footer">
        <el-button @click="dialogPowerVisible = false">取 消</el-button>
        <el-button type="primary" @click="setPowerTemp">确 定</el-button>
      </div>
    </el-dialog>
  </div>
</template>
...
import { getPermissionTree, getRolePermissions, setRolePermissions } from '@/api/permission'
